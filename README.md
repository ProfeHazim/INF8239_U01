# INF-8239 Ciencia de Datos II - Práctica Unidad 01 Laboratorio 01 y 02
...
- **Python:** 3.13.7 (dentro de entorno virtual `.venv`)
- **Librerías principales:** `scikit-learn`, `pandas`, `numpy`, `matplotlib`, `seaborn`, `joblib`, `pytest`.
